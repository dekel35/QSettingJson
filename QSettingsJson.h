...
public:
    ...
    QSettingsJson(QObject *parent = nullptr) :
        QSettings(parent) {}
    QSettingsJson(const QString &fileName, QSettings::Format format, QObject *parent = nullptr) :
        QSettings(fileName, format, parent) {}
    QSettingsJson(QSettings::Format format, QSettings::Scope scope, const QString &organization, const QString &application = QString(), QObject *parent = nullptr) :
        QSettings(format, scope, organization, application, parent) {}
    QSettingsJson(QSettings::Scope scope, const QString &organization, const QString &application = QString(), QObject *parent = nullptr) :
